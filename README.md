...
- Complete opt-in profile sharing through an invisible About Me marker
...
CloudCord keeps feature configuration on-device where possible. BotCord tokens always remain local. Fake Profiles stay local unless the user explicitly chooses Save & Share; the public service stores only visible editor fields and never receives Discord credentials, email addresses or phone numbers.
