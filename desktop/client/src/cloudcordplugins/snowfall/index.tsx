...
export default definePlugin({
    ...
    tags: ["Appearance"],
    authors: [CloudCordDevs.ZcraftElite, CloudCordDevs.square],
    ...
    settingsAboutComponent: () => (
        <>
            ...
            <Paragraph>
                ...
                <br /><br />
                NOTE: While on most computers this plugin will not impact performance any more than your average CloudCord extension,
