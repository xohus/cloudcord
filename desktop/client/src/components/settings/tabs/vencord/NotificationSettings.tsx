    ...
    return (
        <section className={Margins.top16}>
            ...
            <Paragraph className={Margins.bottom8}>
                Settings for notifications sent by CloudCord.
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom8}>
                ...
                <ul>
                    <li><strong>CloudCord Notifications</strong>: These are in-app notifications</li>
            ...
            <Select
                ...
                options={[
                    ...
                    { label: "Always use CloudCord notifications", value: "never" },
