...
export default definePlugin({
    ...
    authors: [Devs.Ven, Devs.Nyako, CloudCordDevs.Loukios, CloudCordDevs.examplegit, CloudCordDevs.qdnx],
    settings,
    contextMenus: {
    ...
    settingsAboutComponent({ tempSettings: s }: { tempSettings?: any; }) {
        ...
        const authorUser = UserStore.getUser(String(CloudCordDevs.examplegit.id));
