...
const settings = definePluginSettings({
    showSincordDonor: {
        ...
        description: "Enable to show Sincord Donor badges in chat.",
        hidden: true,
        default: true
    },
    SincordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Sincord Donor badges.",
        hidden: true,
        default: 0
    },
    showSincordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Sincord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    SincordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Sincord Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    ...
    useEffect(() => {
        images.forEach(image => {
            switch (image.key) {
                case "SincordDonor":
                    settings.store.SincordDonorPosition = image.position;
                    settings.store.showSincordDonor = image.shown;
                    break;
                case "SincordContributer":
                    settings.store.SincordContributorPosition = image.position;
                    settings.store.showSincordContributor = image.shown;
                    break;
                case "VencordDonor":
