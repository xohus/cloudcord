...
import { providers } from "@cloudcordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@cloudcordplugins/musicControls/spotify/lyrics/providers/store";
