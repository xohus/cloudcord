...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@cloudcordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@cloudcordplugins/musicControls/spotify/SpotifyStore";
