...
const NOTIFICATION_AUDIO_URL = "https://raw.githubusercontent.com/CloudCord/Sinbored/main/sounds/waitForSlot/notification.mp3";
...
export default definePlugin({
    ...
    authors: [CloudCordDevs.omaw, Devs.prism],
    settings,
    patches: [
        {
