        ...
        >
            {(_, { isShown }) => (
                <HeaderBarButton
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "CloudCord Toolbox"}
                    icon={Icon}
                    selected={isShown}
                />
            )}
...
migratePluginSettings("CloudCordToolbox", "VencordToolbox");
export default definePlugin({
    name: "CloudCordToolbox",
    description: "Adds a button next to the inbox button in the channel header that houses CloudCord quick actions",
