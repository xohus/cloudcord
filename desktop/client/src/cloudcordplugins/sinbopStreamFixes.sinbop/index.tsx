...
export default definePlugin({
    name: "SinbopStreamFixes",
    description: "Tries to fix stream quality on Sinbop by patching Discord's encoder and quality restrictions.",
    tags: ["Voice"],
    authors: [CloudCordDevs.creations],
    settings,
    ...
    getStreamConfig() {
        ...
        try {
            const state = JSON.parse(localStorage.getItem("SinbopState") ?? "{}");
