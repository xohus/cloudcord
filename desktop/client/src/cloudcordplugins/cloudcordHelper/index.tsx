...
import { Devs, CloudCordDevs, GUILD_ID, SUPPORT_CHANNEL_ID, SUPPORT_CHANNEL_IDS, VC_SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
export default definePlugin({
    ...
    authors: [
        Devs.thororen,
        CloudCordDevs.nyx,
        CloudCordDevs.Naibuu,
        CloudCordDevs.keircn,
        CloudCordDevs.SerStars,
        CloudCordDevs.mart,
        CloudCordDevs.omaw,
        Devs.Samwich,
        Devs.AutumnVN
        ...
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (VC_SUPPORT_CHANNEL_IDS.includes(channelId) && !clicked) {
                return Alerts.show({
                    ...
                    body: "Before asking for help. Check updates and if this issue is actually caused by CloudCord!",
                    confirmText: "CloudCord Support",
                    onConfirm() {
