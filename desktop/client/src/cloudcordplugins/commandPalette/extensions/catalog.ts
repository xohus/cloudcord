...
export const EXTENSIONS_CATALOG: ExtensionDefinition[] = [
    ...
    },
    {
        ...
        commandDescription: "Run the extension command from this detail page.",
        sourcePath: "src/cloudcordplugins/randomVoice",
        tags: [TAG_PLUGINS, TAG_UTILITY],
    ...
    },
    {
        ...
        sourcePath: "src/cloudcordplugins/scheduledMessages",
        tags: [TAG_PLUGINS, TAG_UTILITY],
    ...
    },
    {
        ...
        sourcePath: "src/cloudcordplugins/themeLibrary",
        tags: [TAG_PLUGINS, TAG_UTILITY],
...
export const CLOUDCORD_REPOSITORY_BLOB_BASE_URL = "https://github.com/xohus/cloudcord/blob/main";
...
export function toRepositoryBlobUrl(path: string): string {
    ...
    return `${CLOUDCORD_REPOSITORY_BLOB_BASE_URL}/${normalizedPath}`;
}
