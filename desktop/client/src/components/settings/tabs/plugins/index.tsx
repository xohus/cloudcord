...
export const ExcludedReasons: Record<"web" | "discordDesktop" | "vesktop" | "sinbop" | "desktop" | "dev", string> = {
    ...
    dev: "Developer version of CloudCord"
};
    ...
    const pluginFilter = useCallback((plugin: typeof Plugins[keyof typeof Plugins], newPluginsSet: Set<string> | null) => {
        ...
        switch (status) {
            ...
            case SearchStatus.ENABLED:
                if (!isPluginEnabled(plugin.name)) return false;
                break;
            case SearchStatus.CLOUDCORD:
                if (!PluginMeta[plugin.name].folderName.startsWith("src/cloudcordplugins/")) return false;
                break;
                ...
                <div className={classes(Margins.bottom20, Margins.top8, cl("filter-controls"))}>
                    <Select
                        options={[
                            ...
                            { label: "Show CloudCord", value: SearchStatus.CLOUDCORD },
