...
const settings = definePluginSettings({
    showCloudCordDonor: {
        ...
        description: "Enable to show CloudCord Donor badges in chat.",
        hidden: true,
        default: true
    },
    CloudCordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the CloudCord Donor badges.",
        hidden: true,
        default: 0
    },
    showCloudCordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show CloudCord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    CloudCordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the CloudCord Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://cloudcord.xohus.lol/badges/donor.webp", shown: settings.store.showCloudCordDonor, title: "CloudCord donor badges", key: "CloudCordDonor", position: settings.store.CloudCordDonorPosition },
        { src: "https://cloudcord.xohus.lol/assets/favicon.png", shown: settings.store.showCloudCordContributor, title: "CloudCord contributor badge", key: "CloudCordContributer", position: settings.store.CloudCordContributorPosition },
    ...
    useEffect(() => {
        images.forEach(image => {
            switch (image.key) {
                case "CloudCordDonor":
                    settings.store.CloudCordDonorPosition = image.position;
                    settings.store.showCloudCordDonor = image.shown;
                    break;
                case "CloudCordContributer":
                    settings.store.CloudCordContributorPosition = image.position;
                    settings.store.showCloudCordContributor = image.shown;
                    break;
                case "VencordDonor":
