...
import { CloudCordDevs } from "@utils/constants";
...
const LS_ALL_DATA = "CloudCordCP_allData";
const LS_ALL_ENABLED = "CloudCordCP_allEnabled";
const LS_KEY_DATA = "CloudCordCP_data";
const LS_KEY_ENABLED = "CloudCordCP_enabled";
