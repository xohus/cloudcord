...
export default definePlugin({
    ...
    tags: ["Fun"],
    authors: [CloudCordDevs.SomeAspy, Devs.thororen],
    dependencies: ["AudioPlayerAPI"],
    settings,
    start() {
        croissant = createAudioPlayer("https://github.com/CloudCord/Sinbored/raw/main/sounds/sinissant/croissant.mp3", { persistent: true });
