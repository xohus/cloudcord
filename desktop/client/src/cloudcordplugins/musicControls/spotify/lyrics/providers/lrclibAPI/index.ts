...
import { LyricsData, Provider } from "@cloudcordplugins/musicControls/spotify/lyrics/providers/types";
import { Track } from "@cloudcordplugins/musicControls/spotify/SpotifyStore";
...
export async function getLyricsLrclib(track: Track): Promise<LyricsData | null> {
    ...
    const response = await fetch(url, {
        headers: {
            "User-Agent": "SpotifyLyrics for CloudCord (https://github.com/Masterjoona/vc-spotifylyrics)"
        }
    });
